...
export class DepModal extends BaseComponent {
  ...
  private creditCardAU: Locator = this.page.locator(
    "[data-method-id='devcode_devcode-creditcard-352_creditcard']"
  );
  private neoserf: Locator = this.page.locator(
    "[data-method-id='finteqhub_seamless_finteqhub_seamless-neosurf~neosurf-175_neosurf~neosurf']"
  );
  private paysafecard: Locator = this.page.locator(
    "[data-method-id='finteqhub_seamless_finteqhub_seamless-skrill~skrill-paysafecard-300_skrill~skrill-paysafecard']"
  );
  private creditCardNZ: Locator = this.page.locator(
    "[data-method-id='finteqhub_seamless_finteqhub_seamless-card-acquirer-278_card-acquirer']"
  );
  private interac: Locator = this.page.locator(
    "[data-method-id='finteqhub_seamless_finteqhub_seamless-interac~interac-316_interac~interac']"
  );
  private creditCardCA: Locator = this.page.locator(
    "[data-method-id='finteqhub_seamless_finteqhub_seamless-card-acquirer-380_card-acquirer']"
  );
  private creditCardDE: Locator = this.page.locator(
    "[data-method-id='finteqhub_seamless_finteqhub_seamless-card-acquirer-313_card-acquirer']"
  );
  ...
  private nzCardNumberInput: Locator = this.page.locator(
    '.payment-dynamic-form__credit-card-number > input'
  );
  private nzCardHolderNameInput: Locator = this.page.locator(
    '.payment-dynamic-form__card-holder > input'
  );
  private nzExpiryDateInput: Locator = this.page.locator(
    '.payment-dynamic-form__card-expiry-date > input'
  );
  ...
  private sparkasseDE: Locator = this.page.locator(
    "[data-method-id='finteqhub_seamless_finteqhub_seamless-noda~sparkasse-germany-351_noda~sparkasse-germany']"
  );
  private deutscheBankDE: Locator = this.page.locator(
    "[data-method-id='finteqhub_seamless_finteqhub_seamless-noda~deutsche-bank-germany-348_noda~deutsche-bank-germany']"
  );
  private postbankDE: Locator = this.page.locator(
    "[data-method-id='finteqhub_seamless_finteqhub_seamless-noda~postbank-germany-349_noda~postbank-germany']"
  );
  private revolut: Locator = this.page.locator(
    "[data-method-id='finteqhub_seamless_finteqhub_seamless-noda~revolut-germany-350_noda~revolut-germany']"
  );
  private nodaPay: Locator = this.page.locator(
    "[data-method-id='finteqhub_seamless_finteqhub_seamless-noda~noda-320_noda~noda']"
  );
  ...
  async selectDateFromDatePicker(): Promise<void> {
    ...
    await this.page
      .locator(
        '.react-datepicker__month > .react-datepicker__week  > .react-datepicker__day[aria-disabled="false"]:nth-of-type(1)'
      )
      .first()
      .click();
  }
