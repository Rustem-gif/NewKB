...
export default class SignUpModal extends BaseComponent {
  ...
  private countryDropdownItem = (country: string) =>
    this.page
      .locator('#reg_modal_country_dropdown-menu .select__option')
  ...
  private currencyDropdownItem = (currency: string) =>
    this.page.locator('#reg_modal_currency_dropdown .select__option').filter({ hasText: currency });
  private promoCheckbox: Locator = this.page.locator(
    "[for='reg_modal_promo_checkbox'] .checkbox__point"
  );
  private ageCheckbox: Locator = this.page.locator(
    "[for='reg_modal_age_checkbox'] .checkbox__point"
  );
  private crossSaleCheckbox: Locator = this.page.locator(
    "[for='reg_modal_cross_sale_checkbox'] .checkbox__point"
  );
  ...
  private googleRegBtn: Locator = this.page
    .locator('.auth-providers__icon')
  ...
  private passwordStateBar: Locator = this.page.locator(
    '#modal-root .password-input__strength-progress'
  );
  private stateText: Locator = this.page.locator(
    '#modal-root .password-input__strength-description'
  );
  private passwordTip: Locator = this.page.locator(
    '.registration-dynamic-form__element--password_single .form-element__error'
  );
  private termsAndConditionsLink: Locator = this.page.locator(
    '#modal-root a.terms-acceptance__terms-link'
  );
