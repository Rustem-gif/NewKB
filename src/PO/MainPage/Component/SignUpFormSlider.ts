...
export default class SignUpFormSlider extends BaseComponent {
  ...
  private currencyDropdownItem = (currency: string) =>
    this.page.locator('#main_currency_dropdown .select__option').filter({ hasText: currency });
  ...
  private crossSaleCheckbox: Locator = this.page.locator(
    "[for='cross_sale_checkbox'] .checkbox__point"
  );
  ...
  private discoverMoreButton: Locator = this.page.locator(
    '.registration-form-nomodal__col--promo #discover_more_btn'
  );
