...
export default class MainSliderRegistrationForm extends BaseComponent {
    ...
    private countryDropdown: Locator = this.page.locator('.registration-form-nomodal__country-select')
    private countryDropdownItem = (country: string) => this.page.locator('#main_country_dropdown-menu .select__option').filter({hasText: country})
    private currencyDropdown: Locator = this.page.locator('.registration-form-nomodal__currency-select')
    private currencyDropdownItem = (currency: string) => this.page.locator('.registration-form-nomodal__currency-select .select__option').filter({hasText: currency})
