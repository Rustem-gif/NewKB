...
export default class SignInModal extends BaseComponent {
  ...
  private loginWithGoogleButton: Locator = this.page
    .locator('.login-form__social .auth-providers__icon')
  ...
  private hideShowPasswordButton: Locator = this.page.locator(
    '.login-form__form-element .password-input__visibility-icon'
  );
  private emailInputError: Locator = this.page.locator(
    '.sign-in-page__body .login-form__input.input + .collapse .form-element__error'
  );
  private passwordInputError: Locator = this.page.locator(
    '.sign-in-page__body .password-input + .collapse .form-element__error'
  );
