...
export default class PasswordRecovery extends BasePage {
  public notificationText: string =
    'If your email is within our database, an email with instructions on how to recover your password will be sent in a few minutes';
  public confirmationNotificationText: string = 'confirmation instructions were sent to your email';

  private didntRecieveInstructionsLink: Locator = this.page.locator(
    '.auth-form__instruction-link:nth-of-type(1)'
  );
  ...
  private resendConfirmationInstructionsButton: Locator = this.page.locator(
    '.auth-form__instruction-link:nth-of-type(2)'
  );
