...
test.describe('Password recovery', () => {
    ...
    test('Check password recovery function', async () => {
        ...
        await test.step('Check text of the notification', async () => {
            await expect(kingBilly.passwordRecovery.getPasswordRecoveryNotification).toHaveText(kingBilly.passwordRecovery.getNotificationText)
        })
    })
    ...
    test('Check "Resend confirmation email" functionality', async () => {
        ...
        await test.step('Check text of the notification', async () => {
            await expect(kingBilly.passwordRecovery.getResendConfirmationNotification).toHaveText(kingBilly.passwordRecovery.getConfirmationNotificationText)
        })
    })
