...
test.describe('Main page', () => {
        ...
        test('Check "Next" arrow-shaped button in the promo section',async () => {
            await test.step('Click on "Next" arrow-shaped button', async () => {
                ...
                console.log(await kingBilly.mainPage.promoSection.getSliderButton.getAttribute('currentslide'))
            })

            await test.step('Check current slide number', async () => {
                const currentSlide = await kingBilly.mainPage.promoSection.getSliderButton.getAttribute('currentslide')
