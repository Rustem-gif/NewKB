...
test.describe('Games', () => {
    ...
    test.beforeEach(async ({page}) => {
        ...
        await test.step('Verify user is logged in (using storage state)', async () => {
            await kingBilly.favoriteGames.header.waitForSelector(kingBilly.favoriteGames.header.getDepositButton)
...
test.describe('Game page', () => {
    ...
    test('Check currency change on the game page, choose FUN',async () => {
        ...
        await test.step('Check currency to be FUN', async () => {
            const ingameCurrency = await kingBilly.gamePage.getSidebarCurrencyDropdown.getAttribute('value')
