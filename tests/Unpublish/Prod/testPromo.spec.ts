...
const testDomains = [
  {
    domain: 'master',
    mainPageLink: mainPageLinkMaster,
    promoPageLink: promoPageLinkMaster,
    tournamentPageLink: tournamentPageLinkMaster,
  },
  {
    domain: 'win20',
    mainPageLink: mainPageLinkWin,
    promoPageLink: promoPageLinkWin,
    tournamentPageLink: tournamentPageLinkWin,
  },
  {
    domain: 'bet1',
    mainPageLink: mainPageLinkBet1,
    promoPageLink: promoPageLinkBet1,
    tournamentPageLink: tournamentPageLinkBet1,
  },
];
            ...
            limit(async () => {
              await test.step(`Checking ${lang} Main Page`, async () => {
                ...
                if (creds.type !== 'anon') {
                  ...
                  steps.push(
                    test.step('Promo Main Page Slider', async () => {
                      ...
                      if (!titleIsNotFound) {
                        ...
                        errorSummary.push(
                          `Promo Main Page Slider - ${lang}: ${promoTitle} is found`
                        );
                      } else {
                  ...
                  console.log(
                    chalk.yellow(
                      `Skipping Promo Main Page Slider check for ${lang} as user is anon`
                    )
                  );
                }
                ...
                steps.push(
                  test.step('Tournament Main Page Slider', async () => {
                    ...
                    if (!titleIsNotFound) {
                      ...
                      errorSummary.push(
                        `Tournament Main Page Slider - ${lang}: ${tournamentTitle} is found`
                      );
                    } else {
                ...
                await Promise.all([
                  ...
                  test.step('Tournament Promo', async () => {
                    ...
                    if (!titleIsNotFound) {
                      ...
                      errorSummary.push(
                        `Tournament Promo Page - ${lang}: ${tournamentTitle} is found`
                      );
                    } else {
                ...
                await Promise.all([
                  test.step('Tournament Page Tournament', async () => {
                    ...
                    if (!titleIsNotFoundTournament) {
                      ...
                      errorSummary.push(
                        `Tournament Page Tournament - ${lang}: ${tournamentTitle} is found`
                      );
                    } else {
